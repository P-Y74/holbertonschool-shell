...
Welcome to **Shell, I/O Redirections and Filters**! This repository contains a series of scripts designed to enhance your understanding of input/output redirection, text processing, and command-line filtering in a Unix-based system. These scripts were created as part of a learning project aimed at mastering these fundamental shell operations.
...
5. [Scripts & Usage](#scripts--usage)
   ...
   - [3. Two files](#3-two-files)
   - [4. Last lines](#4-last-lines)
   - [5. First lines](#5-first-lines)
   - [6. Third line](#6-third-line)
   - [7. File](#7-file)
   - [8. CWD state](#8-cwd-state)
   - [9. Duplicate last line](#9-duplicate-last-line)
   - [10. No more js](#10-no-more-js)
   - [11. Directories](#11-directories)
   - [12. Newest files](#12-newest-files)
   - [13. Unique](#13-unique)
   - [14. Find that word](#14-find-that-word)
   - [15. Count that word](#15-count-that-word)
   - [16. Whats next](#16-whats-next)
   - [17. Hide this word](#17-hide-this-word)
   - [18. Letter only](#18-letter-only)
   - [19. AZ](#19-az)
   - [20. Hiago](#20-hiago)
...
Here are some useful materials to help you understand shell I/O redirections and filters:

- **Shell, I/O Redirection**
- **Special Characters in Shell**
- **Understanding Commands like head, tail, find, wc, sort, uniq, grep, tr**
- **File Formats: /etc/passwd and /etc/shadow**
...
- Understand and apply input/output redirection
- Use commands like `head`, `tail`, `find`, `wc`, `sort`, `uniq`, `grep`, and `tr`
- Redirect standard output to a file
- Read standard input from a file instead of the keyboard
- Pipe output from one command to another
- Combine multiple commands with redirections
- Understand and use special characters like spaces, quotes, backslashes, pipes, and command separators
- Work with `/etc/passwd` and `/etc/shadow` files and understand their structure
...
```bash
git clone https://github.com/yourusername/shell-io-redirections.git
```
...
Each of the following exercises demonstrates the use of different shell commands related to I/O redirections and filters:
